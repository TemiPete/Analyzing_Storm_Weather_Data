...
```{r, callTo_changeToOthers, cache=T}
...
```{r, CallTo_changeToExponential, cache=T}
...
Plotting...
```{r, healthDamagePlot, fig.width=20, fig.height=10, cache=T}
...
Plotting...
```{r, economicDamagePlot, fig.width=20, fig.height=10, cache=T}
